  ...
  return (
    <div>
           ...
           
     {
        ...
        students.filter((student) => student.department!==departmentFilter).filter((student) => { return semesterFilter==='Wintersemester'? ( (student.joined.split('-')[1]>='08' && student.joined.split('-')[1]<='12') || (student.joined.split('-')[1]>='01' && student.joined.split('-')[1]<='02') ):(semesterFilter==='Summersemester'? ((student.joined.split('-')[1]>='04' && student.joined.split('-')[1]<='09') ):(<></>)) }).map((student)=> 
       <Fragment>
